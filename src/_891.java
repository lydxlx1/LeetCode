 ...
 *   Let P(A) be the set containing all non-empty sub-sequence of A. Clearly, |P(A)| = 2^n - 1.
 ...
 *
 * Finally, f[i] is clearly equal to 2^i, as A is sorted. (Note, index-i starts from 0).
 */
public class _891 {
